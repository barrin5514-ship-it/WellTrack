...
**A single-page web application that helps users organize and track their daily vitamins, supplements, medications, and hydration.**
...
**## 👥 Part 3: Target Audience \& Value Proposition**
...
**### Smallest Demonstration of Value (MVP)**



**A single-page dashboard for a single user that displays a daily supplement list with dosage, purpose, recommended time of day, and food guidance, allowing the user to mark supplements as taken and instantly see what they have left to do.**
...
**\* Weekly and monthly progress history**
...
**\* Custom supplement scheduling**

**\* User profiles**

**\* Data export**

**\* Sharing progress with doctors, personal trainers, nutritionists, caregivers, and family members**
...
**During development, I used AI coding assistants to brainstorm ideas, debug problems, improve code organization, and learn best practices.**
...
**- \*\*ChatGPT\*\* – Assisted with application architecture, HTML, CSS, JavaScript development, debugging, and UI/UX improvements.**

**- \*\*Google Gemini\*\* – Assisted with brainstorming features, refining code, debugging, and validating implementation ideas.**
...
**- Search supplements instantly**

**- View dosage, timing, and food guidance**
...
**- Automatically save progress using Local Storage**
...
**This project was created for educational purposes as part of the Next Chapter Software Development Program.**
